...
mod tests {
    ...
    fn test_execute_details_timing_acumulate() {
        ...
        let mut other_execute_details_timings =
            construct_execute_timings_with_program(&program_id, us, compute_units_consumed);
        let account_count = 1;
        other_execute_details_timings.serialize_us = Saturating(us);
        other_execute_details_timings.create_vm_us = Saturating(us);
        other_execute_details_timings.execute_us = Saturating(us);
        other_execute_details_timings.deserialize_us = Saturating(us);
        other_execute_details_timings.changed_account_count = Saturating(account_count);
        other_execute_details_timings.total_account_count = Saturating(account_count);
