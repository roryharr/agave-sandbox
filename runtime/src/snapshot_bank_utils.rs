...
mod tests {
    ...
    fn test_snapshot_versioning() {
        ...
        let _ = fs::remove_file(legacy_complete_flag_file);
    ...
    fn test_get_highest_bank_snapshot(should_flush_and_hard_link_storages: bool) {
        ...
        let complete_flag_file = snapshot
            .snapshot_dir
            .join(snapshot_utils::SNAPSHOT_STATE_COMPLETE_LEGACY_FILENAME);
        let _ = fs::remove_file(complete_flag_file);
    ...
    fn test_purge_incomplete_bank_snapshots(should_flush_and_hard_link_storages: bool) {
        ...
        for slot in [1, 2] {
            ...
            let _ = fs::remove_file(state_complete_file);
        }
    ...
    fn test_restore_snapshots_dir_handle_zero_lamport_accounts(storage_access: StorageAccess) {
        ...
        assert_eq!(
            deserialized_bank.get_balance(&key1.pubkey()),
            0,
            "Ensure Account1's balance is zero"
        );
