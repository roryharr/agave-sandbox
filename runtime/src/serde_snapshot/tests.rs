...
mod serde_snapshot_tests {
        ...
        F: Fn(AccountsDb, Slot) -> AccountsDb,
    {
        ...
        // Both purged accounts are tombstones: removed from the index (so they do not load) but
        // retained in storage for incremental snapshots. Neither holds any lamports.
